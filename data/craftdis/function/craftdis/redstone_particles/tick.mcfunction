...
particle dust{color:[1.0,.5,.5],scale:0.9} ~ ~ ~ 0 0 0 0 1 normal @a

tp @s ^ ^ ^0.2

scoreboard players add @s craftdis.misc 1
execute if score @s craftdis.misc matches 30.. if predicate {condition:"random_chance",chance:0.3} run function craftdis:craftdis/redstone_particles/rotate/rotate
