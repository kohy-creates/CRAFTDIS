...
execute store result storage craftdis:craftdis target_location.is_time int 1 if data storage craftdis:craftdis destination_data.is_time
...
execute as @n[type=text_display,tag=craftdis.destination_display] run function craftdis:craftdis/destination/edit_display
